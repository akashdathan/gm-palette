...
describe("Dominant Color", () => {
    describe("Success", () => {
        it("r, g, b to exist in the response", () => __awaiter(this, void 0, void 0, function* () {
            const result = yield index_1.dominantColor(path.resolve(__dirname, '../../sample-image.jpg'));
...
describe("Palette", () => {
    describe("Success", () => {
        it("Array of r, g, b to exist in the response", () => __awaiter(this, void 0, void 0, function* () {
            const result = yield index_1.palette(path.resolve(__dirname, '../../sample-image.jpg'), 3);
